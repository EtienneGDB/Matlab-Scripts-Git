...
for iGroup = 1%:2
    ...
    for iPart = 1:length(part)
        plot(Group_Selected.(Muscles{1})(Group_Selected.(Muscles{1})(:,1)==part(iPart),12))
        title(part(iPart))
        pause()
    end
...
% modif
t(:,1) = [repmat(1,length(Measurment.(Muscles{iM})(:,7))*6,1) 
repmat(2,length(Measurment.(Muscles{iM})(:,7))*6,1)
repmat(3,length(Measurment.(Muscles{iM})(:,7))*6,1)
repmat(4,length(Measurment.(Muscles{iM})(:,7))*6,1)
repmat(5,length(Measurment.(Muscles{iM})(:,7))*6,1)
repmat(6,length(Measurment.(Muscles{iM})(:,7))*6,1)
repmat(7,length(Measurment.(Muscles{iM})(:,7))*6,1)]
%
