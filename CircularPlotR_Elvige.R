...
impVIP<-readMat("J:\\IRSST_Fatigue\\Pointage_repetitif_EMG\\Results\\vipScore.mat")
impVarNames<-readMat("J:\\IRSST_Fatigue\\Pointage_repetitif_EMG\\Results\\Variables.mat")
